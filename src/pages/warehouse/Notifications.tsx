...
const WarehouseNotificationsPage = () => {
  ...
  return (
    <div>
      <PageHeader
        title="الإشعارات"
        description="كل الإشعارات الواردة للمستودع"
        actions={
          unreadCount > 0 && (
          ...
          {error ? (
            ...
            <EmptyState
              ...
              description={
                unreadOnly === "unread"
                  ? "كل إشعاراتك مقروءة"
                  : "ستظهر الإشعارات هنا عند وصول طلبات جديدة أو تحديثات"
              }
            />
          ) : (
...
export default WarehouseNotificationsPage;
